...
void boost_asio_http::http::request::append_raw_msg(std::string &msg)
{
    _raw_msg.append(msg);
}

void boost_asio_http::http::request::add_params(std::string &key, std::string &value)
{
    _params.insert({ key,value });
}

void boost_asio_http::http::request::add_header(std::string &key, std::string &value)
{
    _header.insert({ key,value });
}

void boost_asio_http::http::request::request_method(std::string &method)
{
    _request_method = method;
}

void boost_asio_http::http::request::request_uri(std::string &uri)
{
    _request_uri = uri;
}

void boost_asio_http::http::request::request_version(std::string &version)
{
    _request_version = version;
}

std::string boost_asio_http::http::request::raw_msg()
{
    return _raw_msg;
}

std::string boost_asio_http::http::request::request_method()
{
    return _request_method;
}

std::string boost_asio_http::http::request::request_uri()
{
    return _request_uri;
}

std::string boost_asio_http::http::request::request_version()
{
    return _request_version;
}

std::map<std::string, std::string> boost_asio_http::http::request::params()
{
    return _params;
}

std::map<std::string, std::string> boost_asio_http::http::request::header()
{
    return _header;
}

void boost_asio_http::http::request::first_line_end_index(std::size_t index)
{
    _first_line_end_index = index;
}

void boost_asio_http::http::request::header_end_index(std::size_t index)
{
    _header_end_index = index;
}

void boost_asio_http::http::request::body_end_index(std::size_t index)
{
    _body_end_index = index;
}

std::size_t boost_asio_http::http::request::first_line_end_index()
{
    return _first_line_end_index;
}

std::size_t boost_asio_http::http::request::header_end_index()
{
    return _header_end_index;
}

std::size_t boost_asio_http::http::request::body_end_index()
{
    return _body_end_index;
}

void boost_asio_http::http::request_parser::append_msg(const http_msg_buffer &_http_msg_buffer, const std::size_t &_length)
{
    std::string msg;
...
bool boost_asio_http::http::request_parser::do_parse()
{
...
bool boost_asio_http::http::request_parser::msg_end()
{
    return _request.body_end_index() != 0;
}

boost_asio_http::http::request& boost_asio_http::http::request_parser::get_request()
{
    return _request;
}

bool boost_asio_http::http::request_parser::parser_first_line()
{
...
bool boost_asio_http::http::request_parser::parser_header()
{
    const std::size_t index = _request.raw_msg().find("\r\n\r\n");
    if (index == _request.raw_msg().npos)
    {
...
bool boost_asio_http::http::request_parser::parser_body()
{
